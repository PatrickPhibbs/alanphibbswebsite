export type ProjectCategory = 'New Builds' | 'Renovations' | 'Fit-Outs' | 'Restoration';
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Facade restoration of a protected Victorian building including exterior repainting, ornamental stonework repair, and corbel restoration.',
...
export const categories = ['All', 'New Builds', 'Renovations', 'Fit-Outs', 'Restoration'] as const;
